...
server_notification_definitions! {
    ...
    InferenceWorkStarted => "inferenceWork/started" (v2::InferenceWorkStartedNotification),
    InferenceWorkCompleted => "inferenceWork/completed" (v2::InferenceWorkCompletedNotification),
    InferenceWorkSubtreeIdle => "inferenceWork/subtreeIdle" (v2::InferenceWorkSubtreeIdleNotification),
